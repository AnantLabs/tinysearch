 ...
 * tag's semantic action. Use TagScanner when you have a meta task to do like
 * setting the BASE url for the page when a BASE tag is encountered. If you want
 * to match end tags and handle special syntax between tags, then you'll
 * probably want to subclass {@link CompositeTagScanner} instead.
 */
public class TagScanner implements Scanner, Serializable {
	...
	/**
	 * Scan the tag. For this implementation, the only operation is to perform
	 * the tag's semantic action.
	 * 
	 * @param tag
	 *            The tag to scan.
	 * @param lexer
