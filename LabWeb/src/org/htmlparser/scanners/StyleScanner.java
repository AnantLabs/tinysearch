...
/**
 * The StyleScanner handles style elements. It gathers all interior nodes into
 * one undifferentiated string node.
 */
public class StyleScanner extends CompositeTagScanner {
	...
	/**
	 * Scan for style definitions. Accumulates text from the page, until
	 * &lt;/[a-zA-Z] is encountered.
	 * 
	 * @param tag
