...
public class AndFilter implements NodeFilter {
	...
	/**
	 * Creates a new instance of an AndFilter. With no predicates, this would
	 * always answer <code>true</code> to {@link #accept}.
	 * 
	 * @see #setPredicates
	 */
	public AndFilter() {
	 ...
	 * @param node
	 *            The node to check.
	 * @return <code>true</code> if all the predicate filters find the node is
