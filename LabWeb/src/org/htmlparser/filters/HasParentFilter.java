 ...
 * heirarchy looking for any ancestor that matches the predicate filter. End
 * tags are not considered to be children of any tag.
 */
public class HasParentFilter implements NodeFilter {
	...
	/**
	 * Creates a new instance of HasParentFilter. With no parent filter, this
	...
	/**
	 * Creates a new instance of HasParentFilter that accepts nodes with the
	 * direct parent acceptable to the filter.
	 * 
	 * @param filter
	 *            The filter to apply to the parent.
	 */
	...
	/**
	 * Creates a new instance of HasParentFilter that accepts nodes with a
	 * parent acceptable to the filter.
	 * 
	 * @param filter
	 *            The filter to apply to the parent.
	 * @param recursive
	 *            If <code>true</code>, any enclosing node acceptable to the
	 *            given filter causes the node being tested to be accepted (i.e.
	 *            a recursive scan through the parent nodes up the node
	...
	/**
	 * Accept tags with parent acceptable to the filter. If recursion is
	 * enabled, each parent in turn up to the topmost enclosing node is checked.
	 * Recursion only proceeds while no parent satisfies the filter.
	 * 
	 * @param node
	 *            The node to check.
