...
public class FrameTag extends TagNode {
	...
	/**
	 * Return a string representation of the contents of this <code>FRAME</code>
	 * tag suitable for debugging.
	 * 
	 * @return A string with this tag's contents.
	 */
	public String toString() {
		return "FRAME TAG : Frame " + getFrameName() + " at "
				+ getFrameLocation() + "; begins at : " + getStartPosition()
