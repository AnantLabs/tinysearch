...
public class Index {
	public static void main(String args[]) throws IOException {
		 ...
		 */
		// System.out.println("pageRank...开始");
		 ...
		 */
		// System.out.println("totalAnchorText...开始");
		 ...
		 */
		// System.out.println("inAnchorText...开始");
		...
		/**
		 * 开始索引过程了,依赖inAnchorText.txt, pageRank.txt, source文件夹和index文件夹-dest
		 */
		System.out.println("index...开始");
		LuceneIndex luceneindex = new LuceneIndex(prFile, inATFile, dest);
		luceneindex.setAT();
		luceneindex.setPR();
		for (int i = 0; i < dirnum; i++) {
