...
import javax.swing.JComboBox; //import javax.swing.event.DocumentEvent;
...
// DocumentListener
{
	...
	public String toJavaCode(StringBuffer out, int[] context) {
		...
		out
				.append("\")); } catch (ClassNotFoundException cnfe) { cnfe.printStackTrace (); }");
		newline(out);
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (source == mClass)
			try {
				mFilter.setMatchClass(Class.forName((String) mClass
						.getSelectedItem()));
