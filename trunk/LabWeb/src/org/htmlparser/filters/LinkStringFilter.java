...
public class LinkStringFilter implements NodeFilter {
	...
	/**
	 * Creates a LinkStringFilter that accepts LinkTag nodes containing a URL
	 * that matches the supplied pattern. The match is case insensitive.
	 * 
	 * @param pattern
	...
	/**
	 * Creates a LinkStringFilter that accepts LinkTag nodes containing a URL
	 * that matches the supplied pattern.
	 * 
	 * @param pattern
	 *            The pattern to match.
	 * @param caseSensitive
	...
	/**
	 * Accept nodes that are a LinkTag and have a URL that matches the pattern
