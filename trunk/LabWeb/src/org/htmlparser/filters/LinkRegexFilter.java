...
public class LinkRegexFilter implements NodeFilter {
	...
	/**
	 * Creates a LinkRegexFilter that accepts LinkTag nodes containing a URL
	 * that matches the supplied regex pattern. The match is case insensitive.
	 * 
	 * @param regexPattern
	...
	/**
	 * Creates a LinkRegexFilter that accepts LinkTag nodes containing a URL
	 * that matches the supplied regex pattern.
	 * 
	 * @param regexPattern
	...
	/**
	 * Accept nodes that are a LinkTag and have a URL that matches the regex
	 * pattern supplied in the constructor.
	 * 
	 * @param node
	 *            The node to check.
