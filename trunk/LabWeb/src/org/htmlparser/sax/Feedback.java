...
/**
 * Mediates between the feedback mechanism of the htmlparser and an error
 * handler.
 */
public class Feedback implements ParserFeedback {
	...
	/**
	 * Information message. <em>Just eats the info message.</em>
	 * 
	 * @param message
	 *            {@inheritDoc}
	 */
	...
	/**
	 * Warning message. Calls
	 * {@link ErrorHandler#warning(SAXParseException) ErrorHandler.warning}.
	 * 
	 * @param message
	 *            {@inheritDoc}
	 */
	...
	/**
	 * Error message. Calls
	 * {@link ErrorHandler#error(SAXParseException) ErrorHandler.error}.
	 * 
	 * @param message
	 *            {@inheritDoc}
	 * @param e
