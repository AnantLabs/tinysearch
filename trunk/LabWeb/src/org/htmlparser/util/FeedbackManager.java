...
/**
 * Implementaiton of static methods that allow the parser to route various
 * messages to any implementation of the HTMLParserFeedback interface. End users
 * can use the default DefaultHTMLParserFeedback or may provide their own by
 * calling the setParserFeedback method.
 * 
 * @see ParserFeedback
