...
/**
 * Generic interface for scanning. Tags needing specialized operations can
 * provide an object that implements this interface via getThisScanner(). By
 * default non-composite tags simply perform the semantic action and return
 * while composite tags will gather their children.
 */
public interface Scanner {
	 ...
	 *            tag. Nodes on the stack should be considered incomplete.
