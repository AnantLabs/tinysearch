...
public class FormTag extends CompositeTag {
	...
	public String getFormLocation() {
		if (null == mFormLocation)
			// ... is it true that without an ACTION the default is to send it
	...
	public InputTag getInputTag(String name) {
		...
		inputTag = null;
		found = false;
		for (SimpleNodeIterator e = getFormInputs().elements(); e
				.hasMoreNodes()
				&& !found;) {
	...
	public TextareaTag getTextAreaTag(String name) {
		...
		boolean found = false;
		for (SimpleNodeIterator e = getFormTextareas().elements(); e
				.hasMoreNodes()
				&& !found;) {
	...
	/**
	 * Return a string representation of the contents of this <code>FORM</code>
	 * tag suitable for debugging.
	 * 
	 * @return A textual representation of the form tag.
	 */
	public String toString() {
		return "FORM TAG : Form at " + getFormLocation() + "; begins at : "
				+ getStartPosition() + "; ends at : " + getEndPosition();
	}
