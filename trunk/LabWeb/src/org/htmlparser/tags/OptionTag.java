...
public class OptionTag extends CompositeTag {
	 ...
	 */
	private static final String[] mEnders = new String[] { "INPUT", "TEXTAREA",
			"SELECT", "OPTION" };

	/**
	 * The set of end tag names that indicate the end of this tag.
	 */
	private static final String[] mEndTagEnders = new String[] { "SELECT",
			"FORM", "BODY", "HTML" };
	 ...
	 * 
	 * @return The value of the <code>VALUE</code> attribute, or
	 ...
	 * 
	 * @param value
	 *            The new value of the <code>VALUE</code> attribute.
	 */
	...
	public String toString() {
		String output = "OPTION VALUE: " + getValue() + " TEXT: "
				+ getOptionText() + "\n";
		return output;
	}
