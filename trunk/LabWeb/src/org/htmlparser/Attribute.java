...
public class Attribute implements Serializable {
	 ...
	 * stand-alone attribute. This will be <code>null</code> if the attribute
	 * is whitespace.
	 */
	 ...
	 * <code>null</code> if the attribute is an empty or stand-alone
	 * attribute.
	 */
	 ...
	 * {@link #toString} and {@link #toString(StringBuffer)} methods.
	 */
	public Attribute() {
	 ...
	 * the contents of the stand-alone attribute. <em>WARNING:</em> Setting
	 * this to <code>null</code> can result in malformed HTML if the
	 * assignment string is not <code>null</code>.
	 * 
	 * @param name
	 *            The new name.
	 * @see #getName
	...
	public String getRawValue() {
		...
		if (isValued()) {
			quote = getQuote();
			if (0 != quote) {
				buffer = new StringBuffer(); // todo: what is the value
												// length?
				buffer.append(quote);
				getValue(buffer);
				buffer.append(quote);
