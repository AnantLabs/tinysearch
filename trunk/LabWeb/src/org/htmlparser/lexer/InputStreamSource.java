...
public class InputStreamSource extends Source {
	...
	/**
	 * The stream of bytes. Set to <code>null</code> when the source is
	 * closed.
	 */
	 ...
	 *         or {@link #EOF EOF} if the end of the stream has been reached
	 * @exception IOException
	...
	public long skip(long n) throws IOException, IllegalArgumentException {
		...
		if (0 > n)
			...
			if (mLevel - mOffset < n)
				fill((int) (n - (mLevel - mOffset))); // minimum to satisfy
														// this request
			if (mOffset >= mLevel)
				ret = EOF;
			else {
	...
	/**
	 * Close the source. Once a source has been closed, further
	 * {@link #read() read}, {@link #ready ready}, {@link #mark mark},
	 * {@link #reset reset}, {@link #skip skip}, {@link #unread unread},
