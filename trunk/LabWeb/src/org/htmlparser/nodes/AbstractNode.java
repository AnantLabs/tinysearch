...
/**
 * The concrete base class for all types of nodes (tags, text remarks). This
 * class provides basic functionality to hold the {@link Page}, the starting
 * and ending position in the page, the parent and the list of
...
public abstract class AbstractNode implements Node, Serializable {
	 ...
	 *                This shouldn't be thrown since the {@link Node} interface
	 *                extends Cloneable.
	 */
	...
	/**
	 * Return a string representation of the node. Subclasses must define this
	 ...
	 * collectionList parameter, provided the node satisfies the filtering
	 * criteria.
	 * <P>
	 * 
	 ...
	 * 
	 * @param list
	 *            The node list to collect acceptable nodes into.
	 * @param filter
	 ...
	 * without scanners, i.e. if semantic parsing was not performed. The object
	 * returned from this method can be safely cast to a
	 * <code>CompositeTag</code>.
	 * 
	 ...
	 * 
	 * @param node
	 *            The node that contains this node. Must be a
	 *            <code>CompositeTag</code>.
	 */
	...
	public Node getPreviousSibling() {
		...
		if (numSiblings < 2)// need at least one other node to have a chance of
							// having any siblings
			return null;
	 ...
	 *                <em>Not used.</em> Provides for subclasses that may want
