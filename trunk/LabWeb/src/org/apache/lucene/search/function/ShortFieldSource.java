 ...
 * <code>getShorts()</code> and makes those values available as other numeric
...
public class ShortFieldSource extends FieldCacheSource {
	...
	/**
	 * Create a cached short field source with a specific string-to-short
	 * parser.
	 */
	...
	public DocValues getCachedFieldValues(FieldCache cache, String field,
		...
		final short[] arr = (parser == null) ? cache.getShorts(reader, field)
