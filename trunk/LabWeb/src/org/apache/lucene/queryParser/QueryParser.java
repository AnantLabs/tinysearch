 ...
 * indicating that the clause is required or prohibited respectively; or
 ...
 * a <code>+</code>/<code>-</code> prefix to require any of a set of
 * terms.
 * </ul>
 * 
 ...
 * for "date" fields between 2005-06-01 and 2005-06-04. Note that the format of
 * the accepted input depends on {@link #setLocale(Locale) the locale}. By
 * default a date is converted into a search term using the deprecated
 ...
 * {@link #setDateResolution(String, DateTools.Resolution)}. The former sets
 * the default date resolution for all fields, whereas the latter can be used to
 * set field specific date resolutions. Field specific date resolutions take, if
...
public class QueryParser implements QueryParserConstants {
	 ...
	 * conjuction: the above mentioned query is parsed as
	...
	protected void addClause(Vector clauses, int conj, int mods, Query q) {
		...
		if (clauses.size() > 0 && conj == CONJ_AND) {
			BooleanClause c = (BooleanClause) clauses
					.elementAt(clauses.size() - 1);
			if (!c.isProhibited())
		...
		if (required && !prohibited)
			...
			clauses
					.addElement(new BooleanClause(q, BooleanClause.Occur.SHOULD));
		else if (!required && prohibited)
	 ...
	 * 
	 * @param clauses
	 *            Vector that contains {@link BooleanClause} instances to join.
	 * 
	...
	private static void jj_la1_0() {
		jj_la1_0 = new int[] { 0x180, 0x180, 0xe00, 0xe00, 0x1f69f80, 0x48000,
				0x10000, 0x1f69000, 0x1348000, 0x80000, 0x80000, 0x10000,
				0x18000000, 0x2000000, 0x18000000, 0x10000, 0x80000000,
				0x20000000, 0x80000000, 0x10000, 0x80000, 0x10000, 0x1f68000, };
	}

	private static void jj_la1_1() {
		jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x1, 0x0, 0x0,
				0x0, 0x0, };
	}
