...
public interface IndexCommitPoint {
	...
	/**
	 * Get the segments file (<code>segments_N</code>) associated with this
	 * commit point.
	 */
	 ...
	 * {@link IndexDeletionPolicy} in effect and therefore this should only be
	 * called by its {@link IndexDeletionPolicy#onInit onInit()} or
